      ...
      <div className="info-container row">
        ...
        <div className="contact-us-container col-md-12">
          ...
          <div className="contact-container col-md-7">
            <FiArrowRightCircle size={28} color="#b23137" />{' '}
            <a rel="noopener noreferrer" target="_blank" href="https://www.cin.ufpe.br/~ocovid19">
          ...
          <div className="contact-container col-md-7">
            <FiInstagram size={28} color="#b23137" />{' '}
            <a rel="noopener noreferrer" target="_blank" href="https://www.instagram.com/observatorio.covid.19/">
